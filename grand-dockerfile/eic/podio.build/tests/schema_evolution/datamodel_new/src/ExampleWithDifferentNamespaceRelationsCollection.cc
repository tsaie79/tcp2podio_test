...
ExampleWithDifferentNamespaceRelationsCollection::ExampleWithDifferentNamespaceRelationsCollection() :
...
ExampleWithDifferentNamespaceRelationsCollection::ExampleWithDifferentNamespaceRelationsCollection(ExampleWithDifferentNamespaceRelationsCollectionData&& data, bool isSubsetColl) :
...
ExampleWithDifferentNamespaceRelations ExampleWithDifferentNamespaceRelationsCollection::operator[](std::size_t index) const {
  return ExampleWithDifferentNamespaceRelations(m_storage.entries[index]);
}

ExampleWithDifferentNamespaceRelations ExampleWithDifferentNamespaceRelationsCollection::at(std::size_t index) const {
  return ExampleWithDifferentNamespaceRelations(m_storage.entries.at(index));
}

MutableExampleWithDifferentNamespaceRelations ExampleWithDifferentNamespaceRelationsCollection::operator[](std::size_t index) {
  return MutableExampleWithDifferentNamespaceRelations(podio::utils::MaybeSharedPtr(m_storage.entries[index]));
}

MutableExampleWithDifferentNamespaceRelations ExampleWithDifferentNamespaceRelationsCollection::at(std::size_t index) {
  return MutableExampleWithDifferentNamespaceRelations(podio::utils::MaybeSharedPtr(m_storage.entries.at(index)));
}

std::size_t ExampleWithDifferentNamespaceRelationsCollection::size() const {
  return m_storage.entries.size();
}

bool ExampleWithDifferentNamespaceRelationsCollection::empty() const {
  return m_storage.entries.empty();
}

void ExampleWithDifferentNamespaceRelationsCollection::setSubsetCollection(bool setSubset) {
...
MutableExampleWithDifferentNamespaceRelations ExampleWithDifferentNamespaceRelationsCollection::create() {
  if (m_isSubsetColl) {
    throw std::logic_error("Cannot create new elements on a subset collection");
  }

  auto obj = m_storage.entries.emplace_back(new ExampleWithDifferentNamespaceRelationsObj());
...
void ExampleWithDifferentNamespaceRelationsCollection::clear() {
  m_storage.clear(m_isSubsetColl);
  m_isPrepared = false;
}

void ExampleWithDifferentNamespaceRelationsCollection::prepareForWrite() const {
...
void ExampleWithDifferentNamespaceRelationsCollection::prepareAfterRead() {
...
bool ExampleWithDifferentNamespaceRelationsCollection::setReferences(const podio::ICollectionProvider* collectionProvider) {
  return m_storage.setReferences(collectionProvider, m_isSubsetColl);
}

void ExampleWithDifferentNamespaceRelationsCollection::push_back(MutableExampleWithDifferentNamespaceRelations object) {
  ...
  if (!m_isSubsetColl) {
    ...
    push_back(ExampleWithDifferentNamespaceRelations(object));
  }
}

void ExampleWithDifferentNamespaceRelationsCollection::push_back(ExampleWithDifferentNamespaceRelations object) {
  if (!m_isSubsetColl) {
...
podio::CollectionWriteBuffers ExampleWithDifferentNamespaceRelationsCollection::getBuffers() {
  return m_storage.getCollectionBuffers(m_isSubsetColl);
}


size_t ExampleWithDifferentNamespaceRelationsCollection::getDatamodelRegistryIndex() const {
  return datamodel::meta::DatamodelRegistryIndex::value();
}

podio::SchemaVersionT ExampleWithDifferentNamespaceRelationsCollection::getSchemaVersion() const {
...
podio::CollectionReadBuffers createBuffers(bool isSubset) {
  ...
  readBuffers.type = "ExampleWithDifferentNamespaceRelationsCollection";
  readBuffers.schemaVersion = datamodel::meta::schemaVersion;
  readBuffers.data = isSubset ? nullptr : new ExampleWithDifferentNamespaceRelationsDataContainer;
  ...
  readBuffers.createCollection = [](podio::CollectionReadBuffers buffers, bool isSubsetColl) {
    ExampleWithDifferentNamespaceRelationsCollectionData data(buffers, isSubsetColl);
    return std::make_unique<ExampleWithDifferentNamespaceRelationsCollection>(std::move(data), isSubsetColl);
  };

  readBuffers.recast = [](podio::CollectionReadBuffers& buffers) {
    // We only have any of these buffers if this is not a subset collection
    if (buffers.data) {
      buffers.data = podio::CollectionWriteBuffers::asVector<ExampleWithDifferentNamespaceRelationsData>(buffers.data);
    }
  };
  ...
  readBuffers.deleteBuffers = [](podio::CollectionReadBuffers& buffers) {
    if (buffers.data) {
      ...
      // we can delete
      delete static_cast<ExampleWithDifferentNamespaceRelationsDataContainer*>(buffers.data);
...
bool registerCollection() {
  const static auto reg = []() {
    ...
    factory.registerCreationFunc("ExampleWithDifferentNamespaceRelationsCollection", datamodel::meta::schemaVersion, createBuffers);
...
ExampleWithDifferentNamespaceRelations ExampleWithDifferentNamespaceRelationsCollectionIterator::operator*() {
  m_object.m_obj = podio::utils::MaybeSharedPtr<ExampleWithDifferentNamespaceRelationsObj>((*m_collection)[m_index]);
  return m_object;
}
...
ExampleWithDifferentNamespaceRelationsCollectionIterator& ExampleWithDifferentNamespaceRelationsCollectionIterator::operator++() {
  ++m_index;
  return *this;
}
...
MutableExampleWithDifferentNamespaceRelations ExampleWithDifferentNamespaceRelationsMutableCollectionIterator::operator*() {
  m_object.m_obj = podio::utils::MaybeSharedPtr<ExampleWithDifferentNamespaceRelationsObj>((*m_collection)[m_index]);
  return m_object;
}
...
ExampleWithDifferentNamespaceRelationsMutableCollectionIterator& ExampleWithDifferentNamespaceRelationsMutableCollectionIterator::operator++() {
  ++m_index;
  return *this;
}
...
std::ostream& operator<<(std::ostream& o, const ExampleWithDifferentNamespaceRelationsCollection& v) {
  ...
  for (const auto&& el : v) {
    ...
    o << "      rels : ";
    for (unsigned j = 0, N = el.rels_size(); j < N; ++j) {
      o << el.rels(j).id() << " ";
    }
    o << std::endl;

    o << "      rel : ";
    o << el.rel().id() << std::endl;
...
void ExampleWithDifferentNamespaceRelationsCollection::print(std::ostream& os, bool flush) const {
  os << *this;
  if (flush) {
    os.flush();
  }
