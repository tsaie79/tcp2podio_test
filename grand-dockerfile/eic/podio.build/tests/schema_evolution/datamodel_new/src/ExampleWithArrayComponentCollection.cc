...
ExampleWithArrayComponentCollection::ExampleWithArrayComponentCollection() :
...
ExampleWithArrayComponentCollection::ExampleWithArrayComponentCollection(ExampleWithArrayComponentCollectionData&& data, bool isSubsetColl) :
...
ExampleWithArrayComponent ExampleWithArrayComponentCollection::operator[](std::size_t index) const {
  return ExampleWithArrayComponent(m_storage.entries[index]);
}

ExampleWithArrayComponent ExampleWithArrayComponentCollection::at(std::size_t index) const {
  return ExampleWithArrayComponent(m_storage.entries.at(index));
}

MutableExampleWithArrayComponent ExampleWithArrayComponentCollection::operator[](std::size_t index) {
  return MutableExampleWithArrayComponent(podio::utils::MaybeSharedPtr(m_storage.entries[index]));
}

MutableExampleWithArrayComponent ExampleWithArrayComponentCollection::at(std::size_t index) {
  return MutableExampleWithArrayComponent(podio::utils::MaybeSharedPtr(m_storage.entries.at(index)));
}

std::size_t ExampleWithArrayComponentCollection::size() const {
  return m_storage.entries.size();
}

bool ExampleWithArrayComponentCollection::empty() const {
  return m_storage.entries.empty();
}

void ExampleWithArrayComponentCollection::setSubsetCollection(bool setSubset) {
...
MutableExampleWithArrayComponent ExampleWithArrayComponentCollection::create() {
  if (m_isSubsetColl) {
    throw std::logic_error("Cannot create new elements on a subset collection");
  }

  auto obj = m_storage.entries.emplace_back(new ExampleWithArrayComponentObj());

  obj->id = {int(m_storage.entries.size() - 1), m_collectionID};
  return MutableExampleWithArrayComponent(podio::utils::MaybeSharedPtr(obj));
}

void ExampleWithArrayComponentCollection::clear() {
  m_storage.clear(m_isSubsetColl);
  m_isPrepared = false;
}

void ExampleWithArrayComponentCollection::prepareForWrite() const {
...
void ExampleWithArrayComponentCollection::prepareAfterRead() {
...
bool ExampleWithArrayComponentCollection::setReferences(const podio::ICollectionProvider* collectionProvider) {
  return m_storage.setReferences(collectionProvider, m_isSubsetColl);
}

void ExampleWithArrayComponentCollection::push_back(MutableExampleWithArrayComponent object) {
  ...
  if (!m_isSubsetColl) {
    ...
    push_back(ExampleWithArrayComponent(object));
  }
}

void ExampleWithArrayComponentCollection::push_back(ExampleWithArrayComponent object) {
  if (!m_isSubsetColl) {
...
podio::CollectionWriteBuffers ExampleWithArrayComponentCollection::getBuffers() {
  return m_storage.getCollectionBuffers(m_isSubsetColl);
}

std::vector<SimpleStruct> ExampleWithArrayComponentCollection::s(const size_t nElem) const {
  std::vector<SimpleStruct> tmp;
...
size_t ExampleWithArrayComponentCollection::getDatamodelRegistryIndex() const {
  return datamodel::meta::DatamodelRegistryIndex::value();
}

podio::SchemaVersionT ExampleWithArrayComponentCollection::getSchemaVersion() const {
...
podio::CollectionReadBuffers createBuffers(bool isSubset) {
  ...
  readBuffers.type = "ExampleWithArrayComponentCollection";
  readBuffers.schemaVersion = datamodel::meta::schemaVersion;
  readBuffers.data = isSubset ? nullptr : new ExampleWithArrayComponentDataContainer;
  ...
  readBuffers.createCollection = [](podio::CollectionReadBuffers buffers, bool isSubsetColl) {
    ExampleWithArrayComponentCollectionData data(buffers, isSubsetColl);
    return std::make_unique<ExampleWithArrayComponentCollection>(std::move(data), isSubsetColl);
  };

  readBuffers.recast = [](podio::CollectionReadBuffers& buffers) {
    // We only have any of these buffers if this is not a subset collection
    if (buffers.data) {
      buffers.data = podio::CollectionWriteBuffers::asVector<ExampleWithArrayComponentData>(buffers.data);
    }
  };
  ...
  readBuffers.deleteBuffers = [](podio::CollectionReadBuffers& buffers) {
    if (buffers.data) {
      ...
      // we can delete
      delete static_cast<ExampleWithArrayComponentDataContainer*>(buffers.data);
...
bool registerCollection() {
  const static auto reg = []() {
    ...
    factory.registerCreationFunc("ExampleWithArrayComponentCollection", datamodel::meta::schemaVersion, createBuffers);
...
ExampleWithArrayComponent ExampleWithArrayComponentCollectionIterator::operator*() {
  m_object.m_obj = podio::utils::MaybeSharedPtr<ExampleWithArrayComponentObj>((*m_collection)[m_index]);
  return m_object;
}
...
ExampleWithArrayComponentCollectionIterator& ExampleWithArrayComponentCollectionIterator::operator++() {
  ++m_index;
  return *this;
}
...
MutableExampleWithArrayComponent ExampleWithArrayComponentMutableCollectionIterator::operator*() {
  m_object.m_obj = podio::utils::MaybeSharedPtr<ExampleWithArrayComponentObj>((*m_collection)[m_index]);
  return m_object;
}
...
ExampleWithArrayComponentMutableCollectionIterator& ExampleWithArrayComponentMutableCollectionIterator::operator++() {
  ++m_index;
  return *this;
}
...
void ExampleWithArrayComponentCollection::print(std::ostream& os, bool flush) const {
  os << *this;
  if (flush) {
    os.flush();
  }
